...
// @author       FilunovicU
// @match        https://old.7tv.app/users/*
// @match        https://7tv.app/users/*
// @match        https://old.7tv.app/admin/reports/*
// @match        https://old.7tv.app/emotes/*
...
.banBtn2:before {
content: url(https://i.imgur.com/1B4hbUA.png);
}
    ...
    window.addEventListener('load', function() {
        setTimeout(function() {
            ...
            if (divElement) {
                ...
                buttonElement.className = "banBtn2";
